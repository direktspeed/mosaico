...
mockery.enable();
mockery.registerAllowables(['../src/components/mosaico/js/converter/declarations.js', 'console', './utils.js', './domutils.js', 'console', '../bower_components/mensch'])
...
var processStylesheetRules = require('../src/components/mosaico/js/converter/stylesheet.js');
