/**
 * @module {Module} mosaico/components/game/details <game-details>
...
var youtubeAPI = require("mosaico/models/youtube");
...
/**
 * @constructor mosaico/components/game/details.ViewModel ViewModel
 * @parent mosaico/components/game/details
 *
...
exports.ViewModel = DefineMap.extend('GameDetailsVM',
{
	...
	duration: 'any',
	/**
	* @property {mosaico/models/session} mosaico/components/game/details.session session
	* @parent mosaico/components/game/details.properties
	*
	* A [mosaico/models/session] instance used to track a `Session`
	**/
	session: Session,
	/**
	* @property {mosaico/models/stat} mosaico/components/game/details.stat stat
	* @parent mosaico/components/game/details.properties
	*
	* A [mosaico/models/session] instance used to track a `stat`
	**/
	stat: Stat,
	/**
	 * @property {Promise<mosaico/models/game>|undefined}
	 *
	 * Provides a Game instance with all the stats for the
	 * game and all the player information!
	 *
	 * @signature `Promise<mosaico/models/game>`
	 *
	 ...
	 *
	 * Array of statType objects from [mosaico/models/stat]
	 */
	statTypes: {
	 ...
	 * @property {Object}
	 *
	 * An object of stats sorted by player id from [mosaico/models/stat]
	 */
	 ...
	 * @param  {mosaico/models/player} player The player to show the stat menu for.
	 *
	 * @body
	 *
	 ...
	 * @param {mosaico/models/stat} stat The [mosaico/models/stat] to delete.
...
exports.Component = Component.extend({
	...
	/**
	 * @constructor {can-component.events} mosaico/components/game/details.events Events
	 * @parent mosaico/components/game/details
	 *
