/**
 * @module {Module} mosaico/components/templatesfilled/edit <templatesfilled-create>
 ...
 *
 * @signature `<templatesfilled-create {is-admin} />`
 ...
 * @body
 *
 * To create a `<templatesfilled-create>` element pass a boolean like [mosaico/app.prototype.isAdmin]:
 *
 * ```
 * <templatesfilled-create
...
exports.ViewModel = DefineMap.extend("TemplatesFilledCreateVM",
{
	/**
...
exports.Component = Component.extend({
	tag: "templatesfilled-create",
	view: require("./create.stache!"),
