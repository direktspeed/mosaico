/**
 * @module {Module} mosaico/components/user/details <user-details>
 ...
 *
 *  @param {mosaico/model/session} session The session object. If a user is
 *  currently logged in, contains data about that user.
 *
 *
 * @body
 *
 * To create a `<user-details>` element,  pass the [mosaico/model/session] like:
 *
 * ```
 * <user-details
 *     {session}="session"
...
var Component = require("can-component"),
	User = require("mosaico/models/user"),
	Session = require("mosaico/models/session"),
...
/**
 * @constructor mosaico/components/user/details.ViewModel ViewModel
 * @parent mosaico/components/user/details
 *
...
exports.ViewModel = DefineMap.extend({
	...
	/**
	* @property {Promise} mosaico/components/user/details.savePromise savePromise
	* @parent mosaico/components/users/details.properties
	*
